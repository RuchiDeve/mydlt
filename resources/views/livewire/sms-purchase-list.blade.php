            ...
            <div class="rounded-t mb-0 px-4 py-3 border-0">
                <div class="flex flex-wrap items-center">
                    ...
                    <div class="relative w-full px-4 max-w-full flex-grow flex-1 text-right">
                        @if($authUser->isMember() && !$authUser->hasPendingPurchases())
                    ...
                    @foreach($sms_purchases as $sms_purchase)
                        <tr>
                            ...
                            <td class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-no-wrap p-2">
                                ...
                                wire:click="downloadProof( '{{ $sms_purchase->payment_proof }}' )">
                            ...
                            <td class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-no-wrap p-2">
                                ...
                                font-bold py-2 px-4 rounded inline-flex items-center"
                                                wire:click="approve('{{$sms_purchase->id}}')">
        ...
        <div class="modal-container bg-white w-11/12 md:max-w-md mx-auto rounded shadow-lg z-50 overflow-y-auto">
            ...
            <div class="modal-content py-4 text-left px-6">
                ...
                <div class="flex justify-between items-center pb-3">
                    <p class="text-2xl font-bold">Buy SMS</p>
